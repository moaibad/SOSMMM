...
void selectBox(int xchoice, int *xrow, int *xcol){
	...
	printf("\n   Masukkan lokasi baris : "); scanf(" %c",&rowCharacter);
	switch(rowCharacter){
	    case '1' : row = 1;break;
	    case '2' : row = 2;break;
	    case '3' : row = 3;break;
	    case '4' : row = 4;break;
	    case '5' : row = 5;break;
	    default : printf("\n   Silahkan masukan baris yang sesuai!");rowValid=0;turn=turn-1;getch();break;
	}	

    if (rowValid==1){
    	printf("\n   Masukkan lokasi kolom : "); scanf(" %c",&colCharacter);
    	switch(colCharacter){
	    case '1' : col = 1;break;
	    case '2' : col = 2;break;
	    case '3' : col = 3;break;
	    case '4' : col = 4;break;
	    case '5' : col = 5;break;
	    default : printf("\n   Silahkan masukan kolom yang sesuai!");colValid=0;turn=turn-1;getch();break;
		}
	}
...
void gameEnd(){
    ...
    //Menu Teks
	    if(pilihOpponent=='1'){
	    	if(score1>score2){
	    		gotoxy(43, 7); printf("SELAMAT! %s TELAH MEMENANGKAN PERMAINAN",player1);
	    		gotoxy(43, 8); printf("DENGAN TOTAL SKOR %d",score1);
			}
			else if(score2>score1){
				gotoxy(43, 7); printf("SELAMAT! %s TELAH MEMENANGKAN PERMAINAN",player2);
			...
			if(score1>score2){
				gotoxy(43, 7); printf("SELAMAT! KAMU TELAH MEMENANGKAN PERMAINAN");
		    	gotoxy(43, 8); printf("DENGAN TOTAL SKOR %d",score1);	
			}
			else if(score2>score1){
				gotoxy(43, 7); printf("YAH KAMU KALAHH :(");
				gotoxy(43, 8); printf("TETAP SEMANGAT DAN JANGAN MENYERAH");
			}
			else{
				gotoxy(43, 7); printf("PERMAINAN BERAKHIR SERI");
